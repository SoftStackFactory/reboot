...
describe("Dates service", () => {
  ...
  test("Returns the current date", () => {
    ...
    expect(currentDate).toEqual("2017-07-14"); // Test if the value is equal to this date
  });
  ...
  test("Returns the current month", () => {
    ...
    expect(currentMonth).toBe("July"); // Test if current month equals the month listed
  });
